...
앱별 개인정보처리방침 · 이용약관 호스팅 저장소. GitHub Pages로 서비스한다.
...
## 작성 규칙
- 문서는 **앱 코드 기준**으로 쓴다. 실제로 수집하지 않는 항목을 적거나, 코드가 하지 않는 삭제를
  약속하지 않는다. (창업메이트: 탈퇴 시 Firestore 문서 + Storage의 PDF + 사용량 카운터까지 실제로 삭제)
- 결제·환불 조항은 인앱 상품 구조와 일치시킨다. (창업메이트: 소모성 이용권, 사용 개시 시 청약철회 제한)
- 요금·상품 구성이 바뀌면 약관 제5~8조와 스토어 등록 문구를 함께 고친다.
